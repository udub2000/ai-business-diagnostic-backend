...
def build_diagnostic_responses_pdf(
    ...
    story: list[Any] = [
        ...
        Paragraph(
            f"{xml_escape(_pdf_safe_text(business_name))} &nbsp;&nbsp;|&nbsp;&nbsp; Assessment ID: "
            f"{xml_escape(_pdf_safe_text(assessment_id))}<br/>"
...
3. Original financial statements, when uploaded
"""
    ...
    print(
        f"=== DIAGNOSTIC EMAIL ATTACHMENTS: 2 PDFs + {attached_financial_count} financial file(s) ===",
        flush=True,
    )
